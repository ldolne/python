...
class Elephant:
  ...
  def __str__(self):
    return "Elephant: name is %s, appetite is %s, satisfaction is %s, alive is %s, caretaker is %s" % (self.__name, self.__appetite, self.__satisfaction, self.__alive, self.__care_taker)
